...
- PRD 文档中的数据模型概要章节（来自 PRD 生成 Agent）— 包含实体列表、核心字段、关系概述
- 项目现有数据模型（从代码中提取）

**注意**：PRD 中的数据模型是概要级别，本 Agent 的职责是将其详细展开为完整的数据模型文档。
...
1. 从 PRD 数据模型概要中提取业务实体列表和核心字段
2. 详细展开每个实体的完整属性（补充 PRD 中未列出的字段、审计字段、通用字段）
